"""
This submodule contains objects for handling different data representations.
Whole fit objects can be saved and loaded to and from a YAML file.
Support for more file formats might follow in future updates.

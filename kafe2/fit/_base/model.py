...
class ModelFunctionBase(FileIOMixin, object):
    ...
    def __init__(self, model_function=function_library.linear_model, independent_argcount=1):
        ...
        :param independent_argcount: The amount of independent variables for this model.
        The first n variables of the model function will be treated as independent variables and
        will not be fitted.
    ...
    def _validate_model_function_raise(self):
        ...
        if self._model_function_parcount < 1:
            raise ValueError(
                ...
                "first {1!s} independent variable(s)!".format(
...
class ParametricModelBaseMixin(object):
    ...
    def __init__(self, model_func, model_parameters, *args, **kwargs):
        ...
        :param model_parameters: iterable of parameter values with which the model function should
            be initialized
        """

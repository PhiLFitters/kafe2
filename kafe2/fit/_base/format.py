...
class FunctionFormatter(FileIOMixin, object):
    ...
    def par_formatters(self):
        """List of :py:obj:`ParameterFormatter`-derived objects used for formatting the fit
        parameters, excluding the independent parameter(s).

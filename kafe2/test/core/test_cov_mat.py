...
from kafe2.core.error import CovMat, cov_mat_from_float, cov_mat_from_float_list
    ...
    def setUp(self):
        cm = CovMat(
            [
                ...
                [5.62800000e-02, 2.42004000e-01, 1.09746000e-01, 1.79560000e00, 1.68840000e-02],
                [1.26000000e-03, 5.41800000e-03, 2.45700000e-03, 1.68840000e-02, 9.00000000e-04],
            ]
        )
        self.reference = [2.0, 1.0, 3.0, 2.0, 9.0]
        self.cm = cm
    ...
    def test_rescale(self):
        ...
        _ref = np.array(
            [
                ...
                [5.41800000e-02, 7.39600000e-01, 2.34780000e-02, 2.17803600e00, 2.40800000e-03],
                [4.09500000e-03, 2.34780000e-02, 4.22500000e-03, 1.64619000e-01, 1.82000000e-04],
                [3.79890000e-01, 2.17803600e00, 1.64619000e-01, 3.63609000e01, 1.68840000e-02],
    ...
    def setUp(self):
        ...
        self.ref_fullcor = np.array(
            [
                ...
                [1.34000000e-01, 5.76200000e-01, 2.61300000e-01, 1.79560000e00, 4.02000000e-02],
        ...
        self.ref_singleval_nocor = np.array(
            [[0.015129, 0.0, 0.0], [0.0, 0.015129, 0.0], [0.0, 0.0, 0.015129]]
        )

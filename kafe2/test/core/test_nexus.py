...
class TestNodes(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.func_sum_a_b = Function(TestNodes.sum_function, parameters=(self.par_a, self.par_b))
    ...
    def test_node_iter_parents(self):
        ...
        for _par in par_1, par_2:
            self.assertEqual([_parent for _parent in _par.iter_parents()], [par_lc_1, par_lc_2])
    ...
    def test_node_add_child(self):
        ...
        self.assertEqual([p.value for p in par.get_children()], [1, 2])
    ...
    def test_function_value_lambda(self):
        ...
        func_a_b = Function(lambda a, b: a * 10 + b, name="_lambda", parameters=(par_a, par_b))
    ...
    def test_fallback(self):
        ...
        div_a_b = Fallback((par_a / par_b, "DIV0"), exception_type=ZeroDivisionError)
    ...
    def test_fallback_no_good_alternative(self):
        ...
        div_a_b = Fallback((par_a / 0, 2 * par_a / 0), exception_type=ZeroDivisionError)
    ...
    def test_tuple_iter_values(self):
        tuple_a = Tuple((14, 2))
        self.assertEqual(tuple_a.value, tuple([value for value in tuple_a.iter_values()]))
...
class TestNexus(unittest.TestCase):
    ...
    def test_add_function(self):
        ...
        self.assertEqual([p.name for p in func_node.parameters], ["a", "b"])
    ...
    def test_add_function_existing_parameters(self):
        ...
        self.assertEqual([p.value for p in func_node.parameters], [a.value, b.value])
    ...
    def test_add_function_custom_par_names(self):
        ...
        func_node = self._nexus.add_function(func=my_func, par_names=["x", "y"])
    ...
    def test_add_detect_cycles(self):
        ...
        func_node = self._nexus.add_function(func=my_rec_func, par_names=["my_rec_func_2"])
    ...
    def test_add_dependency(self):
        ...
        func_node = self._nexus.add_function(func=test_func)

...
from .cost import XYMultiCostFunction_Chi2
...
class XYMultiFitEnsemble(FitEnsembleBase):
    ...
    After constructing an :py:obj:`~kafe.fit.XYMultiFitEnsemble` object, an error model should be added
    to it. This is done as for :py:obj:`~kafe.fit.multi.XYMultiFit` objects by using the
    :py:meth:`~kafe.fit.XYMultiFitEnsemble.add_simple_error` or :py:meth:`~kafe.fit.XYMultiFitEnsemble.add_matrix_error`
    methods.

    Once an uncertainty model is provided, the fit ensemble can be generated by using the
    :py:meth:`~kafe.fit.XYMultiFitEnsemble.run` method. This method starts by generating a pseudo-dataset in such a way
    ...
    The ensemble result can be visualized by using the :py:meth:`~kafe.fit.XYMultiFitEnsemble.plot_results` method.
    ...
    def __init__(self, n_experiments, x_support, model_function, model_parameters,
                 cost_function=XYMultiCostFunction_Chi2(axes_to_use='y', errors_to_use='covariance'),
                 requested_results=None):
        """
        Construct an :py:obj:`~kafe.fit.XYMultiFitEnsemble` object.

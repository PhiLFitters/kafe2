#! /usr/bin/env python3
r"""
Fitting two model functions with common parameters
==================================================

Fits of model functions with one or more common parameters
to data sets recorded under very similar conditions are very
frequent in physics. The code below illustrates how to
...
Note that constraints on g1, g2 are needed, i.e. external measurents, 
...
xy_d1.label = 'data set 1'
xy_d1.axis_labels = ['x', 'y (1)']
xy_d2.label = 'data set 2'
